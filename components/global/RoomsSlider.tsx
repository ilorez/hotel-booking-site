    ...
    <div className='bg-[#EEE7DA] py-20'>
        <div className="container mx-auto pt-12 space-y-4">
            <div className='flex items-end'>
                <div className='flex-1 space-y-6'>
                    ...
                    <h1 className='text-6xl max-w-4xl '>
                        Amani... An invitation to comfort, elegance and relaxation
                    </h1>
                    <p className='text-lg max-w-5xl '>
                        Hotel Amani promises a relaxed accommodation experience with comfortable, tastefully decorated rooms.
                        All our rooms are perfectly equipped to offer you the calm and comfort you need for an unforgettable stay in Marrakech.
                    </p>
                </div>
                <Button size={"icon"} variant={"outline"} className='w-20 border-[2px] bg-transparent border-[#0002] hover:bg-[#0002] h-20 rounded-full'><ArrowRight/></Button>
            </div>
        </div>
            <Swiper
                slidesPerView={2.2}
            ...
            >
                ...
                <SwiperSlide className={(i==0?"ml-20":" ")+" py-10"} key={room}>
                    <div className='cursor-pointer hover:-translate-y-4 duration-300'>

                    <img src={room} className='w-full aspect-[3/2] object-cover'></img>
